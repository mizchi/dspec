...
export function renderAppProfileMarkdownReport(report) {
...
export function renderAppProfileReport(report) {
    if (Array.isArray(report.profiles)) {
...
export function renderAppChangeReplayMarkdownReport(report) {
    const lines = [
...
export function renderAppChangeReplayReport(report) {
    if (report.status === "pass") {
...
export function renderAppProfileEvaluationMarkdownReport(report) {
...
export function renderAppProfileScenarioCoverageMarkdownReport(report) {
    const lines = [
...
export function renderAppProfileMutationScoreMarkdownReport(report) {
    const lines = [
...
export function renderAppProfileEvaluationReport(report) {
    if (Array.isArray(report.evaluations)) {
        if (report.status === "pass") {
...
export function renderAppProfileMutationScoreReport(report) {
    if (report.status === "pass") {
