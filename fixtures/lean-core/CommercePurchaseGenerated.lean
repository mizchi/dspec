/-! Generated from Pkl transition system commerce.purchase.atomic-v1. Do not edit by hand. -/
...
def boundedConformance : List String := [
  ...
  "dspec-conformance|path=purchase(quantity=10)>purchase(quantity=10)|" ++
    renderTrace (run initial [.purchase 10, .purchase 10]),
  "dspec-conformance|path=purchase(quantity=10)>purchase(quantity=10)>purchase(quantity=10)|" ++
    renderTrace (run initial [.purchase 10, .purchase 10, .purchase 10])
]
